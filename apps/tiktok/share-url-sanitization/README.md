...
internal val urlShorteningFingerprint = fingerprint {
    ...
    strings("getShortShareUrlObservab\u2026ongUrl, subBizSceneValue)") // Kotlin intrinsics debug string (36.5.4 smali_classes15/X/UEU.smali:392)
    custom { method, classDef ->
        val impl = method.implementation ?: return@custom false
        classDef.endsWith("/UEU;") &&
            method.name == "LIZLLL" &&
            impl.instructions.lastOrNull()?.opcode == Opcode.RETURN_OBJECT
    }
}
```
